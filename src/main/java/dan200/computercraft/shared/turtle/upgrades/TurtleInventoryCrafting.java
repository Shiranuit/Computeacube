...
public class TurtleInventoryCrafting extends InventoryCrafting
{
    ...
    public ArrayList<ItemStack> doCrafting( World world, int maxCount, int craftingtable )
    {
        ...
        if (craftingtable < 1 || craftingtable > 4) {
	        // Find out what we can craft
        	result = tryCrafting( 0, 0 );
	        if( result.isEmpty() )
	        {
